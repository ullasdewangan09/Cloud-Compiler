 ...
 * WebGL 2D background featuring topographic neon lines and sand-ripple movement.
 * Works in all themes (always renders dark neon - great contrast for auth cards).
 */
export function ProceduralGroundBackground() {
  ...
  return (
    <div className="fixed inset-0 w-full h-full -z-10" style={{ background: '#0a0810' }}>
      <canvas
        ref={canvasRef}
